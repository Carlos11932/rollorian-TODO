...
-- AddForeignKey
ALTER TABLE "AgentClient" ADD CONSTRAINT "AgentClient_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "AgentAuditEvent" ADD CONSTRAINT "AgentAuditEvent_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
