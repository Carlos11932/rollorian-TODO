...
- [x] 3.4 Add API/integration tests in `tests/integration/api/` covering CRUD validation, stable item shape for task/event, view endpoints, filters, and history retrieval parity for agents.
