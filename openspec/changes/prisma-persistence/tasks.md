...
- [ ] 1.1 Expand `prisma/schema.prisma` with `User`, `Group`, `Membership`, `Space`, `Item`, `ItemAssignee`, `Label`, `ItemLabel`, `GroupAuditEntry`, and `GroupAuditChange`, including scope uniqueness and item/version constraints.
